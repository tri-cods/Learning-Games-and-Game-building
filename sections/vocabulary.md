...
- **Macro** and **Hook** statement: `(font: "Arial")[This text will be in Arial.]`
...
- Text style: `(text-style:"fade-in-out")[This text blinks]`

- Text/element color: `(color:magenta)[This text is magenta]`

- Background color: `(bg:green)[This text has a green background]`

- Font customization: `(font:"courier")[This text uses a different font]`

- Text size: `(text-size:0.5)[This text is smaller than other text]`

- Alignment of content: `(align:"=><=")+(box:"X")[This text is centered]`

- Rotation: `(text-rotate-z:90)[This text is rotated 90 degrees]`
